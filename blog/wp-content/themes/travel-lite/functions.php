...
// Load the D5 Framework Optios Page
	...
	add_theme_page( 'D5 Creation Themes', 'D5 Creation Themes', 'edit_theme_options', 'd5-themes', 'travel_d5_themes' );
	...
	function travel_d5_themes() {  require_once ( trailingslashit(get_template_directory()) . 'inc/d5-themes.php' ); }
...
// 	Functions for adding some custom code within the head tag of site
	...
	#container .thumb {background: url("<?php if (travel_get_option('ft-back', get_template_directory_uri() . '/images/thumb-back.jpg') != '') : echo travel_get_option('ft-back', get_template_directory_uri() . '/images/thumb-back.jpg'); else:  echo  get_template_directory_uri() . '/images/thumb-back.jpg'; endif; ?>") no-repeat scroll 0 0 #CCCCCC;}
	</style>
