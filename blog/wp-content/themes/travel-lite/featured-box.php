...
<p><?php echo esc_textarea(travel_get_option('featured-description' . $fboxn, 'A Smart way of Natural Presence. This is a Test Description and you can change it from the Theme Options.')); ?></p>
</span>
<?php } ?>
</div> <!-- featured-boxs -->
...
<p><?php echo esc_textarea(travel_get_option('fcontent-description' . $fboxn2, '<b>ASmart way of Natural Presence</b><p>A Smart way of Natural Presence. This is a Test Content and you can change it from the Theme Options.</p>')); ?></p>
</span>
<?php  } ?>
