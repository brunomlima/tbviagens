<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompreOnline.aspx.cs" Inherits="CompreOnline" %>
...
<body>
    ...
    <div class="container">
	    <h3 class="tittle few">Nesta área disponibilizamos para você diversos serviços que podem ser comprados online</h3>
		<div class="about-top">
            <b>ATENÇÃO: </b>Efetue 
            a sua compra utilizando os links abaixo e após concluir a compra entre em 
            contato pelo telefone (11) 2305-3530 para que seja feita uma validação dos serviços 
            adquiridos.<br />
            Informamos que alguns links NÃO são compatíveis com dispositivos móveis, sugerimos utilizar um computador.            
    	    </div>
            <br />
            <!--Primeira linha-->
            <div class='b-one b-two'>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p9.jpg'> 
                        <div class='overlay'> 
                        <h2>Compra de Ingressos</h2> 
                        <a class='info' href='https://tbviagens.minhaviagem.com.br'>Compra Online</a>
                        </div>
                    </div>
                </div>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p10.jpg'> 
                        <div class='overlay'> 
                        <h2>Chip de Celular Pré Pago para usar no Exterior</h2> 
                        <a class='info' href='https://mystore.mysimtravel.com/tbviagens'>Compra Online</a>
                        </div>
                    </div>
                </div>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p11.jpg'> 
                        <div class='overlay'> 
                        <h2>Seguro Viagem</h2> 
                        <a class='info' href='http://www.gtawlabel.com.br/tbviagens'>Compra Online</a>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <div class='b-one b-two'>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p12.jpg'> 
                        <div class='overlay'> 
                        <h2>Locação de Veículos</h2> 
                        <a class='info' href='https://sgrentals.com.br/iframe/home/?idUser=22172'>Compra Online</a>
                        </div>
                    </div>
                </div>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p14.jpg'> 
                        <div class='overlay'> 
                        <h2>Passagens Aéreas</h2> 
                        <a class='info' href='https://www.e-agencias.com.br/tbviagens/home/flights'>Compra Online</a>
                        </div>
                    </div>
                </div>
                <div class='col-md-4 bt-left'>
                    <div class='hovereffect'>
                        <img class='img-responsive' src='imagens/top-p13.jpg'> 
                        <div class='overlay'> 
                        <h2>Compra de Hotel</h2> 
                        <a class='info' href='Hotel.aspx'>Compra Online</a>
                        </div>
                    </div>
                </div>
            </div> 
