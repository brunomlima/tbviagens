<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CancelamentoEmailMarketing.aspx.cs" Inherits="CancelamentoEmailMarketing" %>
...
<title>TBViagens - Agência de Viagens - Cotação de Pacotes Turísticos</title>
...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="banner two">
		 <div class="container">
		    <h2 class="second">Cancelamento</h2>
		 </div>
     </div>
</div>
<!--/contact-->
					...
					<div  class="tip-main">
                        ...
                        <tr>
                            <td class="style1" colspan="2">
                                <asp:TextBox ID="txtEmail" runat="server" Width="300px"  MaxLength="50"></asp:TextBox>
                                <br />
                                <IMG height="30" alt="" src="Captcha.aspx" width="80">
                                <br />
                        Digite o número apresentado na imagem acima
                                *<br />
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                                                ...
                                                                <asp:Button ID="btnGravar" runat="server" 
                                                                    onclick="btnGravar_Click" Text="Cancelar" style="height: 26px" />
