...
<!--start-about-->
   <div class="about">
    <div class="container">
	    <h3 class="tittle few">Algumas palavras sobre a TBViagens</h3>
		<div class="about-top">
					<div>
						<h4>Somos uma agência de viagens que iniciou as atividades em 2012, uma agência 
                            que 
                            esta crescendo dia a dia, com a ajuda de nossos amigos, clientes e fornecedores.</h4>
						<p class="para1">&nbsp;</p>
                        <p class="para1"><strong>Missão </strong></p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">A TBViagens tem como missão ser uma agência de turismo com foco no 
                            atendimento personalizado aos seus clientes, criando um vínculo de amizade e 
                            prezando pelo bem-estar e conforto deles antes, durante e depois das viagens. 
                            Proporcionando sempre, segurança e tranquilidade em suas viagens, com serviços 
                            eficientes, confortáveis e divertidos. Auxiliar nossos clientes não apenas na 
                            realização de suas viagens, mas sim na realização de seus sonhos, fazendo de 
                            pequenos instantes grandes e inesquecíveis momentos, sempre atentos a 
                            responsabilidade social e ambiental. Superando todos os desafios com dedicação, 
                            agilidade, eficiência, excelência, tecnologia, confiança e transparência, isto 
                            significa atender os nossos clientes de forma exclusiva, identificando suas 
                            necessidades e garantindo sua plena satisfação. É uma agência especializada em 
                            prestação de serviços e gestão de viagens negócios, lazer, eventos e incentivos. </p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1"><strong>Visão </strong></p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">Tornar-se referência no segmento de agências de turismo por meio do 
                            crescimento de sua carteira de clientes, sendo sempre muito bem recomendada 
                            pelos mesmos por prestar um serviço e atendimento de primeira qualidade. Ser 
                            inovadora no segmento de turismo, através da gestão baseada em princípios 
                            éticos, condutas, valores e compromissos com nossos clientes, colaboradores e 
                            fornecedores visando o benefício social. Oferecer serviços e produtos 
                            diferenciados e personalizados que possam fidelizar nossos clientes. Ser líder 
                            no mercado de viagens corporativas, garantindo os menores custos, personalização 
                            no atendimento e excelência na prestação dos serviços. </p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1"><strong>Filosofia </strong></p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">Somos uma empresa comprometida com os sonhos dos nossos clientes, 
                            por isso buscamos atende-los da melhor maneira possível, procurando personalizar 
                            cada viagem ao estilo do cliente para que a viagem torne produtiva, interativa, 
                            informativa e o melhor...inesquecível. Nossa relação se pauta na integridade e 
                            ética, pois acreditamos e respeitamos cada cliente. Essa filosofia vem marcando 
                            a nossa participação no mercado. </p>
					</div>
				</div>
        </div>
     </div>
