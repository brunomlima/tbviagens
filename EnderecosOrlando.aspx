<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnderecosOrlando.aspx.cs" Inherits="EnderecosOrlando" %>
...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="banner two">
		 <div class="container">
		    <h2 class="second">Espaço do cliente</h2>
		 </div>
     </div>
</div>
		  ...
		  <div class="top-places">
		     <div class="container">
			     <h3 class="tittle">Conte a sua história</h3>
			    <div class="tip-main">
			      <div>
					 <h4>Se você também quer compartilhar sua experiência aqui neste espaço?
                      Então envie um e-mail para seu agente de viagem com o texto, uma selfie e algumas fotos da sua viagem.</h4>
                  </div>
                </div>
             </div>
          </div>
...
<%--				 <div class="blog">
				   <div class="col-md-4 blog-text">
					   <h5>Local --- Esquerdo</h5>
					   <a href="single.html"><h4>NOME DA PESSOA</h4></a>
					   <p>Texto.</p>
				   </div>
					<div class="col-md-8 welcome-img">
					 <a href="single.html" class="mask"><img src="imagens/b1.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div>
			    <div class="blog">
				 <div class="col-md-4 blog-text two">
					...
					<div class="col-md-8 blog-img two">
					 <a href="single.html" class="mask"><img src="imagens/b2.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div> --%>
               <% ShowEnderecos.ShowBig(); %>
