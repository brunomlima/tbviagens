...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="banner two">
		 <div class="container">
		    <h2 class="second">Cotação de Pacotes Turísticos</h2>
		 </div>
     </div>
</div>
<!--/contact-->
    ...
    <form id="form2" runat="server">
                   ...
                   <h4 class="style2">Para fazer sua cotação preencha o formulário<asp:ScriptManager 
...
&nbsp;<span class="style1" style="color: rgb(255, 0, 0)">*</span></td>
    ...
    &nbsp;<span class="style1"><span style="color: rgb(255, 51, 0)">*</span></span></td>
        ...
        <tr>
            <td>
    <asp:TextBox ID="txtDestino" runat="server" Width="400"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
