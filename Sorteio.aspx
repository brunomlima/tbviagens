<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sorteio.aspx.cs" Inherits="Sorteio" %>
...
<title>TBViagens - Agência de Viagens - Sobre Nós</title>
...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="banner two">
		 <div class="container">
		    <h2 class="second">Sorteio de Prêmios</h2>
		 </div>
     </div>
</div>
<!--start-about-->
   <div class="about">
    <div class="container">
	    <h3 class="tittle few">Regras para Participar do Sorteio</h3>
		<div class="about-top">
					<div>
						<h4>O prêmio para o primeiro sorteio será uma Caneca Térmica o resultado final será 
                            publicado nesta página no dia XX/XX/2016.</h4>
						<p class="para1">&nbsp;</p>
                        <p class="para1"><strong>Como participar do sorteio</strong></p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">Curta a nossa FanPage no Facebook
                            <a href="https://www.facebook.com/tbviagens/">clicando aqui </a>e faça seu 
                            cadastro no final desta página, após efetuar o cadastro você receberá um e-mail 
                            confirmando sua inscrição.</p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">No dia do sorteio o sistema enviará um e-mail avisando o ganhador. </p>
                        <p class="para1">&nbsp;</p>
                        <p class="para1">E nós publicaremos nesta página o nome do ganhador, 
                            boa sorte!</p>
                        <p class="para1">&nbsp; </p>
					</div>
				</div>
   ...
   <!--contact-->
    <form id="form1" runat="server">
		<div class="contact" id="contact">
			<div class="container">
			 <h3 class="tittle">Cadastro para Sorteio</h3>
