<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="AdminPacotesImagens1.aspx.cs" Inherits="Admin_AdminPacotesImagens1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%;">
        ...
        <tr>
            <td>
                Título do Pacote<td colspan="2">
                <asp:Label ID="lblTitulo" runat="server" Text="Titulo do pacote"></asp:Label>
            </td>
        </tr>
